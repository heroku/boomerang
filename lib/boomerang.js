...
(function() {
  ...
  Boomerang = (function() {
    function Boomerang(options) {
      ...
      document.querySelector("#boomerang a.toggler").addEventListener('click', this.toggleMenu);
      this.body.classList.add("boomerang");
    }
